        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="header">
                <marquee behavior="scroll" direction="left"  >
                    WELCOME TO RELOAD CARDS SALES MANAGER
                </marquee>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ url('products-reports') }}"><i class="fa fa-circle-o"></i> Products Reports</a></li>
                    <li><a href="{{ url('employees-reports') }}"><i class="fa fa-circle-o"></i> Employees Reports</a></li>
                    <li><a href="{{ url('vendors-reports') }}"><i class="fa fa-circle-o"></i> Vendors Reports</a></li>
                </ul>
            </li>
        </ul>
        <!-- /.sidebar-menu -->
